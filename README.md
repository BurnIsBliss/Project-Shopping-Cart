...
Need to use react router, react testing, css modules, API promise etc.

1. Think about the components and the functionalities that I need.
2. Think about the folder structure.
3. On the homepage make the image blink and the anchor tag translate.
4. Shop page:
...
5. Cart page link on the nav bar:
...
7. Use the provided API to fetch the items.
8. Test the app using React Testing Library.
